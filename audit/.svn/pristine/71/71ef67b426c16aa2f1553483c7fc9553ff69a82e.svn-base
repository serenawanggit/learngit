...
public class AS_GJ_CZFX {
	...
	private String zydm;
	@ExcelAnnotation(exportname = "是否师范专业")
	private String sfsfz;
	@ExcelAnnotation(exportname = "年制")
	private String nz;
	@ExcelAnnotation(exportname = "毕业生数")
	private String byss;
	@ExcelAnnotation(exportname = "招生数")
	private String zss;
	...
	@ExcelAnnotation(exportname = "四年级及以上在校生")
	private String sinjjyszxs;
	...
	public String getSfsfz() {
		return sfsfz;
	}

	public void setSfsfz(String sfsfz) {
		this.sfsfz = sfsfz;
	}
	...
	public void setSinjjyszxs(String sinjjyszxs) {
		this.sinjjyszxs = sinjjyszxs;
	}
	...
	public String toString(){
		...
		sb.append(getXk() + "|" + getZyfl() + "|"  +getZymc() + 
				"|" +  getZzzymc()+"|" +  getZydm() + "|" + getSfsfz() + "|" + getNz() +
				"|" +  getByss() +  "|" + getZss() + 
				"|" +  getZxshj() +
				"|" +  getYnjzxs() + "|" +  getEnjzxs()+ 
				"|" +  getSanjzxs() + "|" + getSinjjyszxs() + 
				"|" + getYjbyss()+ "|" + getId());
		return sb.toString();
	}
}
