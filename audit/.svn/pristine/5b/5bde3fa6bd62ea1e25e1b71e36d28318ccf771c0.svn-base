...
<script type="text/javascript" src="<%=basePath%>page/zenith/staticPage/js/inspect4.js" ></script>	
...
<script type="text/javascript" src="/audit/page/zenith/staticPage/js/latool.js"></script>
...
<input type="hidden" id="userIdss" value="<%=CookieUtil.getValueByCookie(request, "uvocookie", "id") %>">
	<div id="main" style="Z-index:1">
		...
		<div id="midle">
			<div style="width:100%;height:35px"><div style="float:right"></div>
			<div id="showContext">
				<div> 
			...
			<div style="padding-top:20px"> 
					<div style="border:#B9B9B9 solid 1px;width:100%;height:50px;background-color:#DCDBDB;text-align:center;line-height:50px;" id="rankss"><font style="text-align:center;color:#313131;font-size:15px;font-weight:bold;">总意见&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="ranks" value="优"  checked="checked">优&nbsp;<input type="radio" name="ranks"  value="良">良&nbsp;<input type="radio" name="ranks"  value="中">中&nbsp;<input type="radio" name="ranks"  value="差">差</font> <span id="socre"></span></div>
					<textarea id="zongyijian"  style="border:#B9B9B9 solid 1px;color:#B9B9B9;font-weight:bold;height:150px;width:100%;font-size:15px"></textarea>
				</div>
