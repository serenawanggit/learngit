	...
	<script type="text/javascript">
		$(function(){
			...
			$(".li").click(function(){
				//alert(1425);
				$(".li").attr("style","none");
				$(this).attr("style","background-color:#E6E6E6;border:1px solid #999;border-right:none; width:100%;");
			});
		});
	</script>
...
<body>
	...
	<div id="main_1" style="width:100%">
		<table style="width:100%;height:100%" border="1">
			<tr>
				<td width="300px">
					<div style="width:100%;height:100%;overflow-y:scroll;scrollbar-face-color: #CDCDCD;">
	...
	                 		<li  style="width:100%"><a href="myhuifu.html" class="li" target="cont">我的回复</a></li>
		...
		                 	<li style="width:100%" ><a href="updatebasicdata.html" class="li" target="cont">修改资料</a></li> -->
				...
				<td align="center"><div style="width:96%;height:96%;">
