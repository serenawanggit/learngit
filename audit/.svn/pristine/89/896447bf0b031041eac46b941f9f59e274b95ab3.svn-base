...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>page/xueyuan/staticPage/js/home_2.js"></script>
    	...
    	<div id="right">
    		<div id="top">
    			<div id="left1">
    				<div>
    					<ul id="tab">
    						<li><div onclick="clickTab(0)" style="cursor:pointer">专家反馈报告</div></li>
    			...
    			<div id="right1">
    				<div>
    					<ul id="tab2">
    						...
    						<li><div><a href="/audit/page/xueyuan/staticPage/Specialty.jsp"  style="cursor:pointer"><img alt="返回列表" src="<%=basePath%>page/zenith/staticPage/img/back.png"></a></div></li>
