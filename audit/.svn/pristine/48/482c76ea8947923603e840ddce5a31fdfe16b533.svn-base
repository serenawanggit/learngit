...
<!-- 												<option>2011</option> -->
				...
				<tfoot>
					<tr>
						<td colspan="7">
							<font color="red">※ 数据来源：表6-8学生社团。<br/>
【注】：1.此表为全校数据统计；		</font>						
						</td>
					</tr>
				</tfoot>
			...
			$("#year").change(function(){
				...
				$.ajax({
					...
					success : function(data){
						...
						$("#table_4_7 tbody").html("<tr><td colspan=\"7\"><font color=\"red\"><b>该年份下没有数据</b></font></td></tr>");
 						
							hideLodding();
							return;
						}
						//alert(result);
						/* $("#table_4_7 tbody tr:eq(0) td:eq(0)").html("团队个数");
						$("#table_4_7 tbody tr:eq(1) td:eq(0)").html("参与人次数");
						*/
