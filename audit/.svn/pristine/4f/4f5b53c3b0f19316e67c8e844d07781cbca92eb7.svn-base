...
<!-- 												<option>2011</option> -->
				...
				<tfoot>
					<tr>
						<td colspan="16">
							<font color="red">※ 以上数据来源：表1-6-1教职工基本信息。<br/>
【注】此表为表2.9学校实验技术人员结构的详细信息。
。	</font>				
						</td>
					</tr>
				</tfoot>
			...
			$("#year").change(function(){
				...
				$.ajax({
					...
					success : function(data){
						...
						// hide
							hideLodding();
							$("#table_F_7 tbody").html("<tr><td colspan=\"16\"><font color=\"red\"><b>该年份下没有数据</b></font></td></tr>");
							return;
						}
						var html="";
