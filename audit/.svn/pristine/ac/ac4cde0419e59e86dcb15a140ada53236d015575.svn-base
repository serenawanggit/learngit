...
function queryuploadplan(ach){
	...
	if(ach=="2"||ach=="4"){//上报计划关键字检索
		var pnvalue=$1("plannameinput").value.trim();
	...
	if(typeof(res.statusInfo)=="undefined"){
		if(ach=="1"||ach=="2"||ach=="3"||ach=="4"){
			...
			*/
					...
					for(var i=0;i<res.length;i++){
						...
						*/
						...
						shtml+="<tr style='background-color:"+itembk+";'>";
							...
							//教育部统计数据-上报计划 表格内容 修改删除操作
							shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>";
								shtml+="<a href='#' ename='update' style='display:none;' onclick='editedudptplanthml(this);return false;' value='"+storeplan+"'><img src='images/bj_icon.png' style='vertical-align:middle;' border='0'><span style='display:inline-block;width:30px;text-align:center;'>编辑</span></a>";
								shtml+="<a href='#' ename='delete' style='display:none;' onclick='deleteuploadplan(this);return false;' value='"+res[i].id+"'><img src='images/sc_icon.png' style='vertical-align:middle;border:0px;'><span style='display:inline-block;width:30px;text-align:center;'>删除</span></a>";
							shtml+="</td>";
			...
			if(ach=="3"){
				//操作权限 上海市核心（计划上报）
				showUserMenuOperation(3,103);
			}
			if(ach=="1"){
					//操作权限 教育部 （上报计划）
				showUserMenuOperation(3,104);
			}
		}else if(ach=="5"){
			/*
			[{"id":1,"planname":"2013年数据上报计划","status":0,"plantype":0,"pointtime":"2012-09-01","planyear":"2012","shcoolyear":"2012-2013","totalnums":1,"ctime":"2014-08-07 18:02:05.0430000"}]
...
function queryedubasetab(ach,pid){
	...
	if(ach=="1"){
		...
		var tabinputvalue=$1("tabinput").value.trim();
...
function queryedubasetab_result_pro(txt,ach,values){
	...
	if(typeof(res.statusInfo)=="undefined"){
			...
			*/
			...
			shtml+="<table style='font-size:12px;border:#DADADA 1px solid;width:100%;' cellpadding='0' cellspacing='0'>";
				...
				shtml+="<tr style='background-color:#E6E6E6;color:#333333;font-weight:bold;font-size:12px;'>";
					...
					shtml+="</td>";
					shtml+="<td style='width:50px;' align='center'>表号</td>";
					shtml+="<td style='width:100px;' align='center'>数据表名</td>";
					shtml+="<td style='width:90px;'  align='center'>要求统计时间</td>";
					shtml+="<td style='width:90px;' align='center'>计划统计时间</td>";
					if($("#modelChecked").val()!='3.0模板'){
					shtml+="<td style='width:90px;' align='center'>生成状态</td>";
					shtml+="<td style='width:90px;' align='center'>上次生成时间</td>";
					shtml+="<td style='width:90px;' align='center'>操作</td>";
					}
				shtml+="</tr>";
				...
				for(var i=0;i<res.length;i++){
					...
					shtml+="<tr style='background-color:"+itembk+";'>";
						shtml+="<td style='width:60px;height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;' align='center'>";			//if(res[i].createstatus=="1"){
								shtml+="<input type='checkbox' name='selected' value='"+basetabinfo+"_"+res[i].zyear+"'>";
							//}else{
						...
						shtml+="</td>";
						*/
						shtml+="<td style='width:50px;border-top:#DADADA 1px solid;' align='center'>"+res[i].codes.replace(/_/g,"-")+"</td>";
						shtml+="<td style='width:200px;border-top:#DADADA 1px solid;' align='center'>";
							/* if(res[i].createstatus=="1"){ */
								shtml+="<a href='#' onclick='getjasperreport(this);return false;' value='"+basetabinfo+"_0_"+res[i].zyear+"' style='display:inline-block;width:200px;text-align:center;'>"+getpttype(res[i].RNAME,0)+"</a>";
							/*}else{
						...
						shtml+="<td style='width:90px;border-top:#DADADA 1px solid;' align='center'>"+getpttype(res[i].RNAME,1)+"</td>";
						shtml+="<td style='width:90px;border-top:#DADADA 1px solid;' align='center'>"+timeyear+"</td>";
						if($("#modelChecked").val()!='3.0模板'){
						shtml+="<td style='width:90px;border-top:#DADADA 1px solid;' align='center'>";
						...
						shtml+="<td style='width:90px;border-top:#DADADA 1px solid;' align='center'>"+getcreatetime(res[i].ctime)+"</td>";
						
						shtml+="<td style='width:90px;border-top:#DADADA 1px solid;' align='center'>";
							shtml+="<a href='#' ename='details' style='display:none;' onclick='vieweducreatetabdetail(this);return false;' value='"+basetabinfo+"_0_"+timeyear+"'><img src='images/ck_icon.png' border='0px' title='' alt='' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;color:#333333;'>查看</span></a> ";
							
								shtml+="<a href='#' ename='generate' style='display:none;' onclick='createEduTab(this);return false;' value='"+basetabinfo+"_1_"+res[i].zyear+"'><img src='images/ct_icon.png' border='0px' title='' alt='' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;color:#333333;'>生成</span></a>";	
			...
			*/
			...
			shtml+="<table id='basetabhtml' style='font-size:12px;border:#DADADA 1px solid;width:100%;' cellpadding='0' cellspacing='0'>";
				...
				for(var i=0;i<res.length;i++){
					...
					shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'><input type='text' value='"+timeyear+"' style='padding-left:5px;padding-right:5px;text-align:center;'></td>";
					if(tttime=="自然年"){
						shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'><a href='#' onclick='updatebasetabpt(this);return false;' value='"+res[i].pmid+"_"+(i+1)+"_1'>更新时间</a></td>";
					}else if(tttime=="学年"){
						shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'><a href='#' onclick='updatebasetabpt(this);return false;' value='"+res[i].pmid+"_"+(i+1)+"_2'>更新时间</a></td>";
					}else if(tttime=="时点"){
						shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'><a href='#' onclick='updatebasetabpt(this);return false;' value='"+res[i].pmid+"_"+(i+1)+"_3'>更新时间</a></td>";
					}
			...
			shtml+="<table style='font-size:12px;border:#DADADA 1px solid;width:100%;' cellpadding='0' cellspacing='0'>";
				...
				for(var i=0;i<res.length;i++){
					...
					shtml+="<tr style='background-color:"+itembk+";'>";
						...
						shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>"+getpttype(res[i].RNAME,1)+"</td>";
						shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>"+timeyear+"</td>";
						shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>";
							if(res[i].createstatus=="1"){
								//shtml+="<span style='color:#FFFFFF;background-image:url(images/bk_ok.png);display:inline-block;width:60px;height:24px;line-height:24px;text-align:center;font-size:12px;'>"+getstatus(res[i].createstatus)+"</span>";
								shtml+="<img src='images/bk_ok.png' style='width:50px;height:22px;'>";
						...
						shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>";
							if(res[i].createstatus=="1"){
								shtml+="<a href='#' ename='details' style='display:none;' onclick='vieweducreatetabdetail(this);return false;' value='"+basetabinfo+"_2' >详情</a>";
							}else{
								shtml+="<span ename='details' style='display:none;'><a href='#'  style='display:inline-block;width:200px;text-align:center;color:#999999;' onclick='alert(&quot;还未生成，无法查看！&quot;);return false;' value=''>详情</a></span>";
							}
						shtml+="</td>";	
			...
			shtml+="<table style='font-size:12px;border:#DADADA 1px solid;width:100%;' cellpadding='0' cellspacing='0'>";
				...
				for(var i=0;i<res.length;i++){
					...
					shtml+="<tr style='background-color:"+itembk+";'>";
						...
						shtml+="<td style='width:200px;border-top:#DADADA 1px solid;' align='center'>";
							if(res[i].createstatus=="1"){
								shtml+="<a href='#' style='display:inline-block;width:200px;text-align:center;' onclick='vieweducreatetabdetail(this);return false;' value='"+basetabinfo+"_2' >"+getpttype(res[i].RNAME,0)+"</a>";
							}else{
								shtml+="<a href='#' style='display:inline-block;width:200px;text-align:center;color:#999999;' onclick='alert(&quot;还未生成，无法查看！&quot;);return false;' value='' >"+getpttype(res[i].RNAME,0)+"</a>";
							}
						shtml+="</td>";
						...
						shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>";						
							if(res[i].createstatus=="1"){
								shtml+="<a href='#' ename='details' style='display:none;' onclick='viewjybimptabdetail(this);return false;' value='"+basetabinfo+"' ><img src='images/ck_icon.png' border='0px' title='' alt='' style='vertical-align:middle;'><span style='display:inline-block;width:60px;text-align:center;color:#333333;'>查看明细</span></a>";
							}else if(res[i].createstatus=="0"){
								shtml+="<a href='#' ename='details' style='display:none;' onclick='alert(&quot;教育部数据还未执行生成，无法查看导入明细&quot;);return false;'><img src='images/ck_icon_no.png' border='0px' title='' alt='' style='vertical-align:middle;'><span style='display:inline-block;width:60px;text-align:center;color:#999999;'>查看明细</span></a>";
							}
						shtml+="</td>";
			...
			*/
			...
			shtml+="<table id='basetabhtml' style='font-size:12px;border:#DADADA 1px solid;width:100%;' cellpadding='0' cellspacing='0'>";
				...
				for(var i=0;i<res.length;i++){
					...
					shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>"+getpttype(res[i].RNAME,1)+"</td>";
					shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'><span style='padding-left:5px;padding-right:5px;text-align:center;'>"+timeyear+"</span></td>";
		...
		if(edubasecp=="1"){
			$1("recorddiv").innerHTML="<table style='height:100%;width:100%;font-size:20px;'><tr><td align='center'>教育部数据上报基础表查询没有结果</td></tr></table>";
		}else{
			showalert("没有更多的数据了!");
		}
	}
	if($("#modelChecked").val()=='3.0模板'){
		$("a[ename='generateAll']").hide();
		$("a[ename='exportAll']").hide();
}
}
...
function updatebasetabpt(obj){
	...
	var pms="GLTP="+tp+"&pmid="+pmid[0]+"&time="+d.getTime();
	if(pmid[2]==1){
		pms+="&zyear="+pttime;
	}else if(pmid[2]==2){
		pms+="&syear="+pttime;
...
function updateallbasetabpt(obj){
	...
	var syear=$("#schoolyearinput").val();
	var zyear=$("#zyearinput").val();
...
function updateallbasetabpt_result_pro(txt,ach,values){
	...
	if(res.statusInfo=="GEO010140"){
		edubasecp=1;
		edubasemodel="1";
		if($("#upid").val()!=undefined){
			queryshjwbasetab("4",values);
		}else{
...
function getpttype(tabname,tp){
	if(tp==0){//获取名称
		if(tabname.indexOf("自然年")!=-1){
			tabname=tabname.replace("自然年","").replace("(","").replace(")","").replace("[","").replace("]","").replace("（","").replace("）","");
		}else if(tabname.indexOf("学年")!=-1){
			tabname=tabname.replace("学年","").replace("(","").replace(")","").replace("[","").replace("]","").replace("（","").replace("）","");
		}else if(tabname.indexOf("时点")!=-1){
			tabname=tabname.replace("时点","").replace("(","").replace(")","").replace("[","").replace("]","").replace("（","").replace("）","");
		}else if(tabname.indexOf("近一届")!=-1){
			tabname=tabname.replace("近一届","").replace("(","").replace(")","").replace("[","").replace("]","").replace("（","").replace("）","");
		}
	}else if(tp==1){//去获取类型
		if(tabname.indexOf("自然年")!=-1){
			tabname="自然年";
...
function queryshjwbasetab(ach,pid){
	...
	if(ach=="1"){
		...
		if($("#zyearselect").val()!="all"){
			pms+="&year="+$("#zyearselect").val();
		}
...
/***********数据查询全部导出 开始*************/
var dataSearch="";
var dataSearchArray2=new Array();
var createAllData="";
var createAllDataArray = new Array();

//导出全部
function searchDataALL(){
	var path = tqccServerPath + "SearchData";
	
	var zyear = $("#zyearselect").val();
	jQuery.ajax({
			url:path,
			type:'POST',
			async:false,
			...
			success:function(result){
				...
				for ( var i = 0; i < data.length; i++) {
					dataSearch= data[i].tabid+"_"+data[i].tabname+"_"+data[i].tabcode ;
					dataSearchArray2.push(dataSearch);
					createAllData = data[i].tabid+"_"+data[i].tabname+"_shjw_"+data[i].zyear+"_"+data[i].tabcode
					createAllDataArray.push(createAllData);
				}
			},error:function(){
				alert("网络异常-获取数据失败...");
			}
...
//********LLP*********//
function dataSearchCK(){
	$("[name=cbAll]:checkbox").attr("checked")? $("[name=cbAll]:checkbox").attr("checked", false):$("[name=cbAll]:checkbox").attr("checked", true);  
};

//过度处理
function submitForm(path,tabinfo){
 		html="<form id='guoduform' action='"+path+"' method='post'><input type='hidden' name='tabinfo' value='"+tabinfo+"'><input type='hidden' name='zyear' value='"+$("#zyearselect").val()+"'></form>";
		$("#recorddiv").append(html);
		$("#guoduform").submit();
		$("#guoduform").remove();
}
//打包下载
function submitForm2(path){
 		html="<form id='guoduform1' action='"+path+"' method='post'><input type='hidden' name='zipname' value='Excel.zip'><input type='hidden' name='filepath' value='c:\\多个目标'></form>";
		$("#recorddiv").append(html);
		$("#guoduform1").submit();
		$("#guoduform1").remove();
}
//单个下载
function submitForm3(path,fileName){
		html="<form id='guoduform2' action='"+path+"' method='post'><input type='hidden' name='tabName' value='"+fileName+"'><input type='hidden' name='stype' value='111111'></form>";
	$("#recorddiv").append(html);
	$("#guoduform2").submit();
	$("#guoduform2").remove();
}
//TODO 批量下载
function uploadAll(ara){
	addloadding();
	var zyear = $("#zyearselect").val();
	if(ara){
		dataSearch="";//清空原数据
		if($("[name=cbAll]").is(':checked')==false){
			showalert("请选择需要导出的行");
			return;
		}
		var tabinfo = $("[name=cbAll]:checked");
		for (var i=0;i<tabinfo.length;i++) {
			dataSearch+=tabinfo[i].value+",";
		}
	}else{
		searchDataALL();
		dataSearch="";
		dataSearch = dataSearchArray2+",";//把全部的数据给dataSearch
	}
	var path = tqccServerPath+"UpLoadAll";

		jQuery.ajax({
			url:path,
			type:'POST',
			async:false,
			data:{"dataSearch":dataSearch,"zyear":zyear,"isAll":"isAll"},
			dateType:'json',
			success:function(result){
				if(result=="null"){
					showalert("该年份下没有数据");
	...
	submitForm2("/TQCSERVER/UpLoadAllService");
...
function queryshjwbasetab_result_pro(txt,ach){
	...
	if(typeof(res.statusInfo)=="undefined"){
		if(ach=="1"||ach=="2"){
			...
			shtml+="<table style='font-size:12px;border:#DADADA 1px solid;width:100%;' cellpadding='0' cellspacing='0'>";
				...
				for(var i=0;i<res.length;i++){
					...
					shtml+="<tr style='background-color:"+itembk+";'>";
						...
						shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>"+getcreatetime(res[i].ctime)+"</td>";
						shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>";
							shtml+="<a href='#' ename='search' style='display:none;' onclick='viewtabinfoofjwupload(this);return false;' value='"+tabinfo+"'><img src='images/ck_icon.png' border='0px' title='' alt='' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;color:#333333;'>查看</span></a> ";
							shtml+="<a href='#' ename='generate' style='display:none;' onclick='createshjwtab(this);return false;' value='"+tabinfo+"'><img src='images/ct_icon.png' border='0px' title='' alt='' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;color:#333333;'>生成</span></a>";
						shtml+="</td>";
			...
			*/
			var shtml="<input type='hidden' id='upid' value='0'>";
			shtml+="<table id='basetabhtml' style='font-size:12px;border:#DADADA 1px solid;width:100%;' cellpadding='0' cellspacing='0'>";
				...
				for(var i=0;i<res.length;i++){
					...
					if(res[i].uptimetype=="时点"){
						...
						shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'><input type='text' value='"+res[i].zyear+"' style='padding-left:5px;padding-right:5px;text-align:center;'></td></td>";
					}else if(res[i].uptimetype=="学年"){
						shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'><input type='text' value='"+res[i].syear+"' style='padding-left:5px;padding-right:5px;text-align:center;'></td></td>";
					}
					if(res[i].uptimetype=="时点"){
						shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'><a href='#' onclick='updatebasetabpt(this);return false;' value='"+res[i].pmid+"_"+(i+1)+"_"+"3'>更新时间</a></td>";
					}else if(res[i].uptimetype=="自然年"){
						shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'><a href='#' onclick='updatebasetabpt(this);return false;' value='"+res[i].pmid+"_"+(i+1)+"_"+"1'>更新时间</a></td>";
					}else if(res[i].uptimetype=="学年"){
						shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'><a href='#' onclick='updatebasetabpt(this);return false;' value='"+res[i].pmid+"_"+(i+1)+"_"+"2'>更新时间</a></td>";
					}
		...
		}else if(ach=="5"||ach=="6"||ach=="7"){//上海市核心（数据查询）
			/*
			[{
				"tabsourcetp":"1",
				"pmid":"2100",
			...
			*/
			var shtml="";
			shtml+="<table style='font-size:12px;border:#DADADA 1px solid;width:100%;' cellpadding='0' cellspacing='0'>";
				shtml+="<tr style='background-color:#E6E6E6;color:#333333;font-weight:bold;font-size:12px;'><td style='width:50px;height:40px;' align='center'><input type='checkbox' onclick='dataSearchCK();' id='dataSearchCK'></td><td style='width:100px;height:40px;' align='center'>序号</td><td style='width:200px;' align='center'>数据表名</td><td style='width:100px;' align='center'>表号</td><td style='width:100px;'  align='center'>要求统计时间</td><td style='width:100px;' align='center'>计划统计时间</td><td style='width:100px;' align='center'>生成状态</td><td style='width:100px;' align='center'>上次生成时间</td><td style='width:100px;' align='center'>操作</td></tr>";
				for(var i=0;i<res.length;i++){
					var itembk="#F5F5F5";
					if(i%2==0){
						itembk="#FFF";
					...
					shtml+="<tr style='background-color:"+itembk+";'>";
					// LLP 数据查询 , checkbox
					shtml+="<td style='width:50px;height:40px;border-top:#DADADA 1px solid;' align='center'><input value='"+basetabinfo+"' type='checkbox' name='cbAll'></td>";
					shtml+="<td style='width:10%;height:40px;border-top:#DADADA 1px solid;' align='center'>"+(i+1)+"</td>";
					shtml+="<td style='width:20%;border-top:#DADADA 1px solid;' align='center'><span style='display:inline-block;text-align:left;width:150px;'>"+res[i].tabname+"</span></td>";
					shtml+="<td style='width:10%;border-top:#DADADA 1px solid;' align='center'>"+res[i].tabcode+"</td>";
					shtml+="<td style='width:10%;border-top:#DADADA 1px solid;' align='center'>"+res[i].uptimetype+"</td>";
					shtml+="<td style='width:10%;border-top:#DADADA 1px solid;' align='center'>"+getcreatetime(res[i].pttime)+"</td>";
					
					shtml+="<td style='width:10%;border-top:#DADADA 1px solid;' align='center'>";
						if(res[i].createstatus=="1"){
							//shtml+="<span style='color:#FFFFFF;background-image:url(images/bk_ok.png);display:inline-block;width:60px;height:24px;line-height:24px;text-align:center;font-size:12px;'>"+getstatus(res[i].createstatus)+"</span>";
							shtml+="<img src='images/bk_ok.png' style='width:50px;height:22px;'>";
						}else{
					...
					shtml+="<td style='width:10%;border-top:#DADADA 1px solid;' align='center'>"+getcreatetime(res[i].ctime)+"</td>";
					shtml+="<td style='width:10%;border-top:#DADADA 1px solid;' align='center'><a href='#' ename='details' style='display:none;' value='"+basetabinfo+"' onclick='viewcreatetabinfo(this);return false;'>详情</a></td>";
				shtml+="</tr>";
			}
			//====================分页查询开始====================
			...
			shtml+="<table style='font-size:12px;border:#DADADA 1px solid;width:100%;' cellpadding='0' cellspacing='0'>";
				...
				for(var i=0;i<res.length;i++){
					...
					shtml+="<tr style='background-color:"+itembk+";'>";
						...
						shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>";
							if(res[i].createstatus=="1"){
								shtml+="<a href='#' ename='details' style='display:none;' value='"+basetabinfo+"' onclick='viewshjwimptabdetail(this);return false;'><img src='images/ck_icon.png' border='0px' title='' alt='' style='vertical-align:middle;'><span style='display:inline-block;width:60px;text-align:center;color:;'>查看明细</span></a>";
							}else if(res[i].createstatus=="0"){
								shtml+="<a href='#' ename='details' style='display:none;' onclick='alert(&quot;上海教委数据还未执行生成，无法查看导入明细&quot;);return false;'><img src='images/ck_icon_no.png' border='0px' title='' alt='' style='vertical-align:middle;'><span style='display:inline-block;width:60px;text-align:center;color:#999999;'>查看明细</span></a>";
							}
						shtml+="</td>";
					shtml+="</tr>";
				}
		...
		if(shjwbasecp=="1"){
			$1("recorddiv").innerHTML="<table style='height:100%;width:100%;font-size:20px;'><tr><td align='center'>数据上报基础表查询没有结果</td></tr></table>";
		}else{
			showalert("没有更多的数据了!");
		}
	}
...
//jasperreport报表显示-->修改成表格样式-->实时的数据
function getjasperreport(obj){
	...
	//初始化
	var d=new Date();
	if($("#modelChecked").val() == "2.0模板"){
		
		var tp=getRTP()[1][9];
		jybTabShowInit(basetabinfo);

		var pms="GLTP="+tp+"&tabname="+basetabinfo[2]+"&zyear="+$("#zyearselect").val()+"&time="+d.getTime();
		new AJAXPOST(pms,tp,basetabinfo[0],basetabinfo);
	}else if($("#modelChecked").val() == "3.0模板"){
		jybTabShowInitfor3(basetabinfo);
		var tp=getRTP()[12][2];
		var pms="GLTP="+tp+"&tabname="+basetabinfo[2]+"&zyear="+$("#zyearselect").val()+"&time="+d.getTime();
		new AJAXPOST(pms,tp,basetabinfo[0],basetabinfo);
	}
...
function createEduTab(obj){
	var basetabinfo=obj.getAttribute("value").split("_");
	var d=new Date();
	var tp=getRTP()[1][10];

	var tpms = "&tabIds=" + basetabinfo[1] + "&tabnames=" + basetabinfo[2]+"&years=" + basetabinfo[4];
	var pms="GLTP="+tp+tpms;
	new AJAXPOST(pms,tp,basetabinfo[0],basetabinfo);
...
function createedutabforbatch(){
	...
	tpms += "&tabIds=" + tabIds + "&tabnames=" + names+"&years=" + years;
	if(tpms.length==0){
...
function queryshjwimport_result_pro(txt,ach){
	...
	if(typeof(res.statusInfo)=="undefined"){
		...
		$1("imdetailddiv").innerHTML="<table style='height:100%;width:100%;font-size:20px;'><tr><td align='center'>教育部导入查询没有结果</td></tr></table>";
...
//	var checklist = document.getElementsByName ("selected");
	searchDataALL();//获取数据
	createAllData = createAllDataArray.join();
	createAllDataArray = createAllData.split(",");//分割
	var tpms="";
	for ( var j = 0; j < createAllDataArray.length; j++) {
		var tabinfo = createAllDataArray[j].split("_");
		tpms+="&tabid="+tabinfo[0]+"&tabname="+b64(tabinfo[1])+"&tabcode="+tabinfo[4];
	}
...
function viewcreatetabinfo(obj){
	...
	var tabinfo=obj.getAttribute("value").split("_");
	//初始化表格样式 addVolunteerData("tabinfo")
	addVolunteerData(tabinfo);
	var zyear=$("#zyearselect").val();
	var d=new Date();
	var tp=getRTP()[3][1];
	var pms="GLTP="+tp+"&tabid="+tabinfo[0]+"&time="+d.getTime()+"&tabcode="+tabinfo[2]+"&zyear="+zyear+"&initData=initData";
	new AJAXPOST(pms,tp,"1",tabinfo);
...
function viewcreatetabinfo_result_pro(txt,ach,values){
	...
	if(typeof(res.statusInfo)=="undefined"){//
		...
		if(tabcode=="tab1"){
			...
			*/
			$1("benkenum").value=res[0].res1;
			//$1("benkenumincrement").value=res[0].benkenumincrement;
			$1("zhuankenum").value=res[0].res2;
	
			$1("shuoshinum").value=res[0].res3;
			$1("boshinum").value=res[0].res4;
			
			$1("liuxuenum").value=res[0].res5;
			$1("yukenum").value=res[0].res6;
			
			$1("jinxiunum").value=res[0].res7;
			$1("tuochannum").value=res[0].res8;
			
			$1("yedanum").value=res[0].res9;
			$1("hanshounum").value=res[0].res10;
			
			$1("totalstunum").value=res[0].res11;
			$1("benkeratio").value=(parseFloat(res[0].res12)*100).toFixed(2)+"%";
			...
			shtml+="<table id='luqulvtable' style='width:710px;border:#DADADA 1px solid;margin-right:10px;' cellpadding='0' cellspacing='0'>";
				...
				for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+ibk+";'>";
							...
							shtml+="<td  align='center'  style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text'  value='"+res[i].res1+"' style='width:100px;padding-left:5px;border:#DADADA 1px solid;'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res2+"'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+valueFormat(res[i].res3,3)+"'></td>";
							shtml+="<td align='center'  style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 0px solid;'><input type='text'  value='"+res[i].res4+"' style='color:#AAAAAA;width:100px;padding-left:5px;border:#DADADA 1px solid;' ></td>";
			...
			shtml+="<table id='luqulvtable' style='width:710px;border:#DADADA 1px solid;margin-right:10px;' cellpadding='0' cellspacing='0'>";
				...
				for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+ibk+";'>";
							...
							shtml+="<td  align='center'  style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text'  value='"+res[i].res1+"' style='width:100px;padding-left:5px;border:#DADADA 1px solid;'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res2+"'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 0px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res3+"'></td>";
						shtml+="</tr>";
...
//			$1("totalzyratio").value=strpercent(res[0].res1);
//			$1("totaltjratio").value=strpercent(resres[0].res2);
//			$1("totalzyratioincrement").value=resres[0].res3;
//			$1("tophighmajor").value=resres[0].res4;
//			$1("toplowmajor").value=resres[0].res5;
			...
			"doctornum":"541"}]
			*/
			$1("zhuanrennum").value=res[0].res1;
			$1("waipinnum").value=res[0].res2;
			$1("totaljsnum").value=res[0].res3;
			$1("zhenggaonum").value=res[0].res4;
			$1("fugaonum").value=res[0].res5;
			
			//$1("zhenggaoincrement").value=res[0].zhenggaoincrement;
			//$1("fugaoincrement").value=res[0].fugaoincrement;
			
			$1("doctornum").value=res[0].res6;
			$1("masternum").value=res[0].res7;
			
			//$1("doctorincrement").value=res[0].doctorincrement;
			//$1("masterincrement").value=res[0].masterincrement;
			
			$1("age30andyoungnum").value=res[0].res8;
			$1("age31to40num").value=res[0].res9;
			$1("age41to50num").value=res[0].res10;
			$1("age51to60num").value=res[0].res11;
			$1("age61andoldnum").value=res[0].res12;
			...
			*/
			...
			$1("waipinnum").value=res[0].res2;
			$1("totaljsnum").value=res[0].res3;
			$1("studentnum").value=res[0].res4;
			$1("stutearatio").value=res[0].res5;
			...
			*/
			$1("studentnum").value=res[0].res1;
			$1("totalequipvalue").value=res[0].res2;
			$1("equipnetincrement").value=res[0].res3;
			$1("equipnetincrementratio").value=strpercent(res[0].res4);
			$1("avgequipvalue").value=res[0].res5;
			$1("avgequipvalueincrement").value=res[0].res6;
			console.info(res[0]);
			...
			*/
			$1("studentnum").value=res[0].res1;
			$1("totalbooknum").value=res[0].res2;
			$1("bookincrement").value=res[0].res4;
			$1("avgbooknum").value=res[0].res3;
			$1("avgbooknumincrement").value=res[0].res5;
			...
			*/
			...
			$1("ebooknum").value=res[0].res1;
			$1("ebookincrement").value=res[0].res3;
			$1("eperiodicalnum").value=res[0].res2;
			$1("eperiodicalincrement").value=res[0].res4;
			...
			*/
			...
			$1("benkenum").value=res[0].res1;
			$1("borrownum").value=res[0].res2;
			$1("borrowincrement").value=res[0].res4;
			$1("avgborrownum").value=res[0].res3;
			$1("avgborrowincrement").value=res[0].res5;
			...
			*/
			...
			$1("totalstunum").value=res[0].res1;
			$1("teacharea").value=res[0].res2;
			$1("officearea").value=res[0].res3;
			$1("teachofficearea").value=res[0].res4;
			
			$1("labarea").value=res[0].res5;
			$1("avgteachofficearea").value=res[0].res6;
			$1("avgteachofficeincrement").value=res[0].res8;
			$1("avglabarea").value=res[0].res7;
			$1("avglabincrement").value=res[0].res9;
			...
			*/
			...
			$1("benkenum").value=res[0].res1;
			$1("totalexpense").value=res[0].res2;
			$1("totalexpenseincrement").value=res[0].res4;
			$1("avgexpense").value=res[0].res3;
			$1("avgexpenseincrement").value=res[0].res5;
			...
			*/
			$1("benkenum").value=res[0].res1;
			$1("teachingfund").value=res[0].res2;
			$1("teachingfundincrement").value=res[0].res3;
			$1("avgteachingfund").value=res[0].res4;
			$1("avgteachingfundincrement").value=res[0].res5;
			...
			*/
			$1("benkenum").value=res[0].res1;
			$1("experimentfund").value=res[0].res2;
			$1("experimentfundincrement").value=res[0].res4;
			$1("avgexperimentfund").value=res[0].res3;
			$1("avgexperimentfundincrement").value=res[0].res5;
			...
			*/
			$1("benkenum").value=res[0].res1;
			$1("practisefund").value=res[0].res2;
			$1("practisefundincrement").value=res[0].res4;
			$1("avgpractisefund").value=res[0].res3;
			$1("avgpractisefundincrement").value=res[0].res5;
				...
				*/
				...
				shtml+="<table id='luqulvtable' style='width:100%;border:#DADADA 1px solid;margin-right:10px;' cellpadding='0' cellspacing='0'>";
					...
					for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+ibk+";'>";
							shtml+="<td align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text'  value='"+res[i].res1+"' style='color:#AAAAAA;width:80px;border:#DADADA 1px solid;padding-left:5px;' readonly></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+res[i].res2+"' style='width:80px;border:#DADADA 1px solid;'></td>";
							shtml+="<td align='center'  style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+res[i].res3+"' style='width:80px;border:#DADADA 1px solid;'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+res[i].res4+"' style='width:80px;border:#DADADA 1px solid;'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;'><input type='text' value='"+res[i].res5+"' style='width:80px;border:#DADADA 1px solid;'></td>";
			...
			$1("totalcredit").value=res[0].res1;
			$1("totalhour").value=res[0].res2;
			$1("avgcredit").value=res[0].res3;
			$1("avgcreditincrement").value=res[0].res4;
			$1("avghour").value=res[0].res5;
			$1("avghourincrement").value=res[0].res6;
			$1("avgtheoryhour").value=res[0].res7;
			$1("avgtheoryhourratio").value=strpercent(res[0].res8);
			$1("avgpractisehour").value=res[0].res9;
			$1("avgpractisehourratio").value=strpercent(res[0].res10);
			...
			*/
			...
			shtml+="<table id='luqulvtable' style='width:100%;border:#DADADA 1px solid;margin-right:10px;' cellpadding='0' cellspacing='0'>";
					...
					for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+ibk+";'>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+res[i].res1+"' style='color:#AAAAAA;padding-left:5px;width:80px;border:#DADADA 1px solid;'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+res[i].res2+"' style='color:#AAAAAA;padding-left:5px;width:80px;border:#DADADA 1px solid;'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+res[i].res3+"' style='width:80px;border:#DADADA 1px solid;'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+res[i].res4+"' style='color:#AAAAAA;padding-left:5px;width:80px;border:#DADADA 1px solid;' readonly></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+res[i].res5+"' style='width:80px;border:#DADADA 1px solid;'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;'><input type='text' value='"+res[i].res6+"' style='color:#AAAAAA;padding-left:5px;width:80px;border:#DADADA 1px solid;' readonly></td>";
			...
			$1("avgelectivecredit").value=res[0].res1;
			$1("avgelectivecreditratio").value=res[0].res2;
			$1("avgpractisecredit").value=res[0].res3;
			$1("avgpractisecreditratio").value=res[0].res4;
		}else if(tabcode=="tab17"){
			/**
			[{"totalcoursenum":"0","totaltimenum":"0"}]
			*/
			$1("totalcoursenum").value=res[0].res1;
			$1("totalcourseincrement").value=res[0].res3;
			$1("totaltimenum").value=res[0].res2;
			$1("totaltimeincrement").value=res[0].res4;
			...
			shtml+="<table id='luqulvtable' style='width:710px;border:#DADADA 1px solid;margin-right:10px;' cellpadding='0' cellspacing='0'>";
				...
				for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+ibk+";'>";
							...
							shtml+="<td  align='center'  style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+res[i].res1+"' style='width:100px;padding-left:5px;border:#DADADA 1px solid;'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res2+"'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res3+"'></td>";
							shtml+="<td align='center'  style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text'  value='"+res[i].res4+"' style='color:#AAAAAA;width:100px;padding-left:5px;border:#DADADA 1px solid;' readonly></td>";
			...
			shtml+="<table id='luqulvtable' style='width:1000px;border:#DADADA 1px solid;margin-right:10px;' cellpadding='0' cellspacing='0'>";
				...
				for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+ibk+";'>";
							...
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res2+"'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res3+"'></td>";
							shtml+="<td align='center'  style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+res[i].res4+"' style='width:100px;padding-left:5px;border:#DADADA 1px solid;'></td>";
							shtml+="<td align='center'  style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+res[i].res5+"' style='width:100px;padding-left:5px;border:#DADADA 1px solid;'></td>";
							
							shtml+="<td align='center'  style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+strpercent(res[i].res6)+"' style='color:#AAAAAA;width:100px;padding-left:5px;border:#DADADA 1px solid;' readonly></td>";
							shtml+="<td align='center'  style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+strpercent(res[i].res7)+"' style='color:#AAAAAA;width:100px;padding-left:5px;border:#DADADA 1px solid;' readonly></td>";
						shtml+="</tr>";
			...
			*/
			$1("basiclessthan30num").value=res[0].res1;
			$1("basic30to59num").value=res[0].res2;
			$1("basic60to89num").value=res[0].res3;
			$1("basic90andmorenum").value=res[0].res4;
			
			$1("basiclessthan30ratio").value=strpercent(res[0].res5);
			$1("basic30to59ratio").value=strpercent(res[0].res6);
			$1("basic60to89ratio").value=strpercent(res[0].res7);
			$1("basic90andmoreratio").value=strpercent(res[0].res8);
			
			$1("majorlessthan30num").value=res[0].res9;
			$1("major30to59num").value=res[0].res10;
			$1("major60to89num").value=res[0].res11;
			$1("major90andmorenum").value=res[0].res12;
	
			$1("majorlessthan30ratio").value=strpercent(res[0].res13);
			$1("major30to59ratio").value=strpercent(res[0].res14);
			$1("major60to89ratio").value=strpercent(res[0].res15);
			$1("major90andmoreratio").value=strpercent(res[0].res16);
				
			$1("totaltimenum").value=res[0].res17;
			$1("totalbasicclassnum").value=res[0].res18;
			$1("totalmajorclassnum").value=res[0].res19;
			$1("totalclassnum").value=res[0].res20;
			
			$1("totalbasicratio").value=strpercent(res[0].res21);
			$1("totalmajorratio").value=strpercent(res[0].res22);
			$1("totallessthan30ratio").value=strpercent(res[0].res23);
			$1("total30to59ratio").value=strpercent(res[0].res24);
			$1("total60to89ratio").value=strpercent(res[0].res25);
			$1("total90andmoreratio").value=strpercent(res[0].res26);
			...
			*/
			$1("benkenum").value=res[0].res1;
			$1("transfernum").value=res[0].res2;
			$1("topindepartment").value=res[0].res3;
			$1("topindepartmentpop").value=res[0].res4;
			$1("topinmajor").value=res[0].res5;
			$1("topinmajorpop").value=res[0].res6;
			
			
			$1("topoutdepartment").value=res[0].res7;
			$1("topoutdepartmentpop").value=res[0].res8;
			
			$1("topoutmajor").value=res[0].res9;
			$1("topoutmajorpop").value=res[0].res10;
			
			$1("transfernumincrement").value=res[0].res11;				
			
			$1("transferratio").value=strpercent(res[0].res12);
			
			$1("transferratioincrement").value=res[0].res13;				
			$1("indeptpopincrement").value=res[0].res14;
			$1("inmajorpopincrement").value=res[0].res15;
			$1("outdeptpopincrement").value=res[0].res16;
			$1("outmajorpopincrement").value=res[0].res17;
			...
			shtml+="<table id='luqulvtable' style='width:100%;border:#DADADA 1px solid;margin-right:10px;' cellpadding='0' cellspacing='0'>";
				...
				for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+ibk+";'>";
							...
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res2+"'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 0px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res3+"'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res4+"'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 0px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res5+"'></td>";
			...
			shtml+="<table id='luqulvtable' style='width:1000px;border:#DADADA 1px solid;margin-right:10px;' cellpadding='0' cellspacing='0'>";
				...
				for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+ibk+";'>";
							...
							shtml+="<td  align='center'  style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+res[i].res1+"' style='width:100px;padding-left:5px;border:#DADADA 1px solid;'></td>";
							shtml+="<td  align='center'  style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+res[i].res2+"' style='width:100px;padding-left:5px;border:#DADADA 1px solid;'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res3+"'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res4+"'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res5+"'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res6+"'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:100px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res7+"'></td>";
			...
			shtml+="<table id='luqulvtable' style='width:100%;border:#DADADA 1px solid;margin-right:10px;' cellpadding='0' cellspacing='0'>";
				...
				for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+ibk+";'>";
							...
							shtml+="<td  align='center'  style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+res[i].res1+"' style='width:80px;padding-left:5px;border:#DADADA 1px solid;'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:80px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res2+"'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:80px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res3+"'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:80px;padding-left:5px;border:#DADADA 1px solid;color:#DADADA;' value='"+strpercent(res[i].res4)+"' readonly></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:80px;padding-left:5px;border:#DADADA 1px solid;' value='"+res[i].res5+"'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:80px;padding-left:5px;border:#DADADA 1px solid;color:#DADADA;' value='"+strpercent(res[i].res6)+"' readonly></td>";
			...
			shtml+="<table id='luqulvtable' style='width:100%;border:#DADADA 1px solid;margin-right:10px;' cellpadding='0' cellspacing='0'>";
				...
				for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+ibk+";'>";
							...
							shtml+="<td  align='center'  style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' value='"+res[i].res1+"' style='width:80px;padding-left:5px;border:#DADADA 1px solid;'></td>";
							shtml+="<td  align='center' style='height:40px;border-top:#DADADA 1px solid;border-right:#DADADA 1px solid;'><input type='text' style='width:80px;padding-left:5px;border:#DADADA 1px solid;' value='"+strpercent(res[i].res2)+"'></td>";	
			...
			*/
			...
			[{"passratio":"0.9475"}]
			*/
			$1("passratio").value=strpercent(res[0].res1);
			$1("passratioincrement").value=res[0].res2;
			...
			*/
			...
			$1("excellentcoursenum").value=res[0].res1;
			$1("excellentcourseratio").value=res[0].res2;
			$1("goodcoursenum").value=res[0].res3;
			$1("goodcourseratio").value=res[0].res4;
			$1("mediumcoursenum").value=res[0].res5;
			$1("mediumcourseratio").value=res[0].res6;
			$1("badcoursenum").value=res[0].res7;
			$1("badcourseratio").value=res[0].res8;
			$1("totalevaluatednum").value=res[0].res9;
		}
	}else{
		$1("zytianchongqu").innerHTML="查询没有结果";
	}
}
...
function viewtabinfoofjwupload(obj){
	...
	//数据上报 查询--LLP
	addVolunteerSearch(tp,tabp.split("_"),tabp.split("_")[2]);
	new AJAXPOST(pms,tp,"1",tabp.split("_"));
										
}
// ** LLP 数据上报 查看处 **/
function addVolunteerSearch(tp,tabp,tabcode){
	var zyear = $("#zyearselect").val();
	...
	jQuery.ajax({
			...
			type: "POST", 
	  		dataType:"JSON",
	  		url:$1("tqccServerPath").value+"TQCService",
	  		data:{"tabcode":tabcode,"GLTP":tp,"zyear":zyear,"search":"search"},
	  		error:function(){
	  			alert('数据上报查询错误..tqc.js function-addVolunteerSearch');
	  		},
	  		success: function(result){
	  			var data = eval(result);
	  			viewshjwcreatetabdetail(tabp,data);
	  		}
	 });
}

// ** LLP 数据查询 详情处 **/
function addVolunteerData(tabinfo){
	var tabcode=tabinfo[2];
	var tp=getRTP()[3][1];
	var zyear = $("#zyearselect").val();
	jQuery.ajax({
		async: false,
		type: "POST", 
  		dataType:"JSON",
  		url:$1("tqccServerPath").value+"TQCService",
  		data:{"GLTP":tp,"zyear":zyear,"tabcode":tabcode,"initData":"searchdata"},
  		error:function(){
  			alert('初始化错误..tqc.js function-addVolunteerData');
  		},
  		success: function(result){
  			var data = eval(result);
  			viewshjwcreatetabdetail(tabinfo,data);
  		}
	});
}

//上海教委数据查询展示
function viewshjwcreatetabdetail(values,data){
		...
		shtml+="<tr>";
			shtml+="<td colspan='2' valign='top' align='center' style='width:100%;background-color:#FFFFFF;height:260px;border-left:#DADADA 1px solid;border-right:#DADADA 1px solid;border-top:#0099FF 1px solid;'>";
					...
					if(tabcode=="tab1"){
						...
						if(data!=null&&data.length>0){
							shtml+=gethtmloftable15("1",data);
						}else{
							shtml+="查询没有结果";
						}
					}else if(tabcode=="tab16"){
						if(data!=null&&data.length>0){
							shtml+=gethtmloftable16("1",data);
						}else{
							shtml+="查询没有结果";
						}
					}else if(tabcode=="tab17"){
						...
						if(data!=null&&data.length>0){
							shtml+=gethtmloftable18("1",data);
						}else{
							shtml+="查询没有结果";
						}
					}else if(tabcode=="tab19"){
						if(data!=null&&data.length>0){
							shtml+=gethtmloftable19("1",data);
						}else{
							shtml+="查询没有结果";
						}
					}else if(tabcode=="tab20"){
						if(data!=null&&data.length>0){
							shtml+=gethtmloftable20("1",data);
						}else{
							shtml+="查询没有结果";
						}
					}else if(tabcode=="tab21"){
						...
						if(data!=null&&data.length>0){
							shtml+=gethtmloftable23("1",data);
						}else{
							shtml+="查询没有结果";
						}
					}else if(tabcode=="tab24"){
						if(data!=null&&data.length>0){
							shtml+=gethtmloftable24("1",data);
						}else{
							shtml+="查询没有结果";
						}
					}else if(tabcode=="tab25"){
						if(data!=null&&data.length>0){
							shtml+=gethtmloftable25_1("1",data);
						}else{
							shtml+="查询没有结果";
						}
					}else if(tabcode=="tab26"){
						if(data!=null&&data.length>0){
							shtml+=gethtmloftable26("1",data);
						}else{
							shtml+="查询没有结果";
						}
					}else if(tabcode=="tab27"){
						if(data!=null&&data.length>0){
							shtml+=gethtmloftable27("1",data);
						}else{
							shtml+="查询没有结果";
						}
					}else if(tabcode=="tab28"){
						if(data!=null&&data.length>0){
							shtml+=gethtmloftable28("1",data);
						}else{
							shtml+="查询没有结果";
						}
					}else if(tabcode=="tab29"){
					...
					}else if(tabcode=="tab31"){
						shtml+='查询没有结果';
					}else if(tabcode=="tab32"){
						shtml+='查询没有结果';
					}
			shtml+="</td>";
		shtml+="</tr>";
...
function vieweducreatetabdetail(obj){
	...
	var pms="GLTP="+tp+"&tabname="+basetabinfo[2]+"&zyear="+basetabinfo[3]+"&time="+d.getTime();
	new AJAXPOST(pms,tp,basetabinfo[0],basetabinfo);
			...
			shtml+="<table style='font-size:12px;border:#DADADA 1px solid;width:100%;' cellpadding='0' cellspacing='0'>";
					...
					for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+itembk+";'>";
							...
							shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>";
								shtml+="<a href='#' ename='update' style='display:none;' onclick='showeditnewtarget(this);return false;' value='"+json2str(res[i])+"'><img src='images/bj_icon.png' border='0px' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;'>编辑</span></a>";
								shtml+="&nbsp;&nbsp;<a href='#' ename='delete' style='display:none;' onclick='deleteindicator(this);return false;' value='"+iwid+"'><img src='images/sc_icon.png' border='0px' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;'>删除</span></a>";
							shtml+="</td>";
						shtml+="</tr>";
					}
						...
						shtml+="<td style='width:100%;height:40px;border-top:#DADADA 1px solid;' colspan='9'>";
							shtml+="<table cellpadding='0' cellpadding='0' style='width:100%;'>";
								shtml+="<tr><td align='left'><span style='display:inline-block;margin-left:40px;'>&nbsp;</span></td>";
									...
									shtml+="<span style='display:inline-block;height:24px;line-height:24px;text-align:center;margin-left:5px;vertical-align:middle;font-size:16px;'>"+icp+"/"+getAllPages(res[0].totalnums,7)+"页</span>";
...
function adddatatabmodel(obj){
	...
	if(dimencondition==null||dimencondition.length<1){
		...
		//alert(dimencols)
		if(dimencondition == dimenrows || dimencondition == dimencols){
			alert("请选择与列维度及行维度不同的筛选条件");
			return;
		}
			...
			shtml+="<table style='font-size:12px;border:#DADADA 1px solid;width:100%;' cellpadding='0' cellspacing='0'>";
					...
					for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+itembk+";'>";
							...
							shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>";
								shtml+="<a href='#' ename='update' style='display:none;' onclick='showeditnewdataxlsmodel(this);return false;' value='"+x+"'><img src='images/bj_icon.png' border='0px' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;'>编辑</span></a>";
								shtml+="&nbsp;&nbsp;<a href='#' ename='delete' style='display:none;' onclick='deletedatatabmodel(this);return false;' value='"+tmid+"'><img src='images/sc_icon.png' border='0px' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;'>删除</span></a>";
							shtml+="</td>";
...
//			shtml+="<option value='all'>所有</option>";
			...
			*/
			...
			$("#datatabmodelcategoryspan").html(shtml);
			...
			//}else{
				...
				for(var i=0;i<res.length;i++){
					...
					if(tabmodel_cols=="0"&&tabmodel_rows=="1"){//时间-院系
						...
						newid=res[i].zb+"_"+res[i].department;
						if(res[i].department=='本科生与专任教师之比'){
						gridvalue="<span style='text-decoration:;'>";
						if(res[i].zhi.split(".").length>1){
						gridvalue+=res[i].zhi.toFixed(2)+"</span>";
						}else{
						gridvalue+=res[i].zhi.toFixed(2)+"</span>";	
						}
...
function editdatatab(obj){
	...
	var d=new Date();
	var tp=getRTP()[8][1];
	var pms="GLTP="+tp+"&rtid="+obj.getAttribute("value")+"&reportname="+b64(reportname)+"&reportlevel="+reportlevel+"&report_zyear="+reportzyear+"&report_status=0&report_tabs="+report_tabs+"&dtcid="+dtcid+"&time="+d.getTime();
	if(pms_tmid!=null&&pms_tmid.length>0){
		pms+=pms_tmid;
	}
	new AJAXPOST(pms,tp,"1");
			...
			shtml+="<table style='font-size:12px;border:#DADADA 1px solid;width:100%;' cellpadding='0' cellspacing='0'>";
					...
					for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+itembk+";'>";
							...
							shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>"+res[i].ctime.substring(0,10)+"</td>";
							shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>";
								shtml+="<a href='#' ename='update' style='display:none;' onclick='showeditnewdataxls(this);return false;' value='"+json2str(res[i])+"'><img src='images/bj_icon.png' border='0px' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;'>编辑</span></a>";
								shtml+="&nbsp;&nbsp;<a href='#' ename='delete' style='display:none;' onclick='deletedatatabedit(this);return false;' value='"+rtid+"'><img src='images/sc_icon.png' border='0px' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;'>删除</span></a>";
							shtml+="</td>";
						shtml+="</tr>";
					}
			...
			shtml+="<table style='font-size:12px;border:#DADADA 1px solid;width:100%;' cellpadding='0' cellspacing='0'>";
					...
					for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+itembk+";'>";
							...
							shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>"+res[i].report_tabs+"</td>";
							shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>"+res[i].ctime.substring(0,10)+"</td>";
							shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'><a  href='#' ename='details' style='display:none;' onclick='showdatatabdetailpreview(this);return false;' value='"+res[i].rtid+"'><img src='images/ck_icon.png' border='0px' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;'>查看</span></a></td>";
						shtml+="</tr>";
					}
...
function addqrmodel(){
	...
	var qrmmodelcontent=window.frames['newscontentframe2'].GetContents();// 修改质量报告模板控件
...
//	var qrmodelcontent=window.frames["newscontentframe"].GetContents(); -- 修改质量报告模板控件
	var qrmodelcontent=window.frames["newscontentframe2"].GetContents();
			...
			shtml+="<table style='font-size:12px;border:#DADADA 1px solid;width:100%;' cellpadding='0' cellspacing='0'>";
					...
					for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+itembk+";'>";
							...
							shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>"+res[i].ctime.substring(0,10)+"</td>";
							shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>";
								shtml+="<a href='#' ename='update' style='display:none;' onclick='showeditqrreporthtml(this);return false;' value='"+xxxx+"'><img src='images/bj_icon.png' border='0px' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;'>编辑</span></a>";
								shtml+="&nbsp;&nbsp;<a href='#' ename='delete' style='display:none;' onclick='deleteqrmodel(this);return false;' value='"+qrmid+"'><img src='images/sc_icon.png' border='0px' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;'>删除</span></a>";
							shtml+="</td>";
						shtml+="</tr>";
					}
...
function getvalueforset(){
	...
	window.frames["newscontentframe2"].InsertHTML(mdcontent) ; // 修改质量报告模板控件
...
function addqreport(){
	...
	if(qryear==null||qryear.length<1){
		...
		if(!(!isNaN(qryear) && parseInt(qryear) > 1990 && parseInt(qryear) < 2100)){
			alert("请输入正确的年份");
			return;
		}
	}
			...
			shtml+="<table style='font-size:12px;border:#DADADA 1px solid;width:100%;' cellpadding='0' cellspacing='0'>";
					...
					for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+itembk+";'>";
							...
							shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>"+res[i].qrmcategoryname+"</td>"; //原来qrmcategoryname得到结果 现在因为使用存储过程得到结果的列改为了qrmcategoryid
							shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>"+res[i].qryear+"年</td>";//同上, 本来year 年份 现在改为了qrmcategoryname
							shtml+="<td style='width:100px;border-top:#DADADA 1px solid;' align='center'>";
							shtml+="<a href='#' ename='details'  style='display:inline-block;width:50px;' onclick='previewqreport(this);return false;' value='"+xxx+"____1'><img src='images/ck_icon.png' border='0px' title='质量报告详情查看' alt='质量报告详情查看' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;'>查看</span></a>";
							
								//shtml+="<a href='#' style='display:inline-block;width:30px;' onclick='previewqreport(this);return false;' value='"+xxx+"'>查看</a>";
								
								shtml+="<a href='#' ename='export'  onclick='previewqreport(this);return false;' style='display:inline-block;width:50px;' value='"+xxx+"____2'><img src='images/dc_icon.png' border='0px' title='质量报告导出' alt='质量报告导出' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;'>导出</span></a>";
							shtml+="</td>";
						shtml+="</tr>";
					}
				...
				shtml+="</table>";
			$("#recorddiv").html(shtml);
			//操作权限 质量报告查询
			showUserMenuOperation(3,115);
			...
			shtml+="<table style='font-size:12px;border:#DADADA 1px solid;width:100%;' cellpadding='0' cellspacing='0'>";
					...
					for(var i=0;i<res.length;i++){
						...
						shtml+="<tr style='background-color:"+itembk+";'>";
							...
							shtml+="<td style='width:;border-top:#DADADA 1px solid;' align='center'>"+res[i].qrmcategoryname+"</td>";	//引来是年份的这个字段qrmcategoryname 现在因为使用了存储过程 该列 得到结果为 qrmcategoryid
							shtml+="<td style='width:;border-top:#DADADA 1px solid;' align='center'>"+res[i].qryear+"年</td>";//qrmcategoryname本来为year 年份 现在因为使用了存储过程 该列 得到结果为 qrmcategoryname 显示的是年份
							shtml+="<td style='width:;border-top:#DADADA 1px solid;' align='center'>";
								shtml+="<a href='#' ename='update' style='display:none;' style='display:inline-block;' onclick='qrreportedithtml(this);return false;' value='"+xxx+"'><img src='images/bj_icon.png' border='0px' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;'>编辑</span></a>";
								shtml+="<a href='#' ename='delete' style='display:none;' style='display:inline-block;' onclick='deleteqreport(this);return false;' value='"+qrid+"'><img src='images/sc_icon.png' border='0px' style='vertical-align:middle;'><span style='display:inline-block;width:30px;text-align:center;'>删除</span></a>";
							shtml+="</td>";
						shtml+="</tr>";
					}
...
function queryqreportdetailbyid_result_pro(txt,ach){
		...
		[
    {
        ...
        "qrid": "13"
			...
			*/
			var thtml="";
			thtml+="<table style='width:100%;border-bottom:red 1px solid; border-collapse: collapse;'>";
				thtml+="<tr>";
			...
			var shtml="";
			shtml+="<div style='width:100%;overflow-x:hidden;'><table style='width:800px;background-color:#FFFFFF;' cellpadding='0' cellspacing='0'>";
			...
			var html ="<html><head><meta http-equiv='Content-Type' content='text/html; charset=gbk'/>";
				html+="<title>质量报告预览-TQC教学质量中心</title><style type='text/css'>";
				html+="body, html{	width: 100%;height: 100%;margin:0;background-color:#F7F7F7;	font: 12px  Arial, Lucida Grande, Tahoma, sans-serif;}</style></head><body><div id='wenjuancontentdiv' style='width:100%;min-height:500px;padding:20px;'>";
				html+="<div style='width:100%;overflow-x:hidden;'>";
				for(var i=0;i<mlarys.length;i++){
					html+="<h3>"+mlarys[i].mlname+"</h3><br/>"+mlarys[i].mlcontent;
				}
				html+="</div></body></html>";
			
			//页面导出
			$1("content").value =html;
			$1("htmlForm").submit();
			...
			for(var i=0;i<mlarys.length;i++){
				...
				if(parseInt(mlarys[i].mid) > max){
					max = parseInt(mlarys[i].mid);
				}

			}
			setTimeout(function () { 
		       window.frames["mluframe"].setzNodes(xznn,max);
...
AJAXPOST=function(pms,tp,ach,values){
	...
	req.onreadystatechange = function () {
		...
		if (req.readyState == 4 && req.status == 200) {
			 ...
			 }else if(tp==getRTP()[1][9]){//查看报表
				getJybTabreport_result_pro(txt,values);
			 }else if(tp==getRTP()[1][10]){//报表生成
				jybTabCreate_result_pro(txt,values);
			 }else if(tp==getRTP()[1][11]){//查看生成报表
				 getJybTabreport_result_pro(txt,values);
			 }else if(tp==getRTP()[1][12]){//报表生成
				 jybTabCreate_result_pro(txt,values);
			 ...
			 }else if(tp==getRTP()[12][0]){
				 queryedubasetab_result_pro(txt,ach,values);
			 }else if(tp==getRTP()[12][1]){
				 queryedubasttabDetail_result_pro(txt,ach,values);
			 }else if(tp==getRTP()[12][2]){
				 queryedubasttabDetail_result_pro(txt,ach,values);
			 }
		}
	};
...
function previewqreport(obj){
	/*
	var xxx=res[i].qrid+"____"+res[i].qrname+"____"+res[i].qrmcategoryid+"____"+res[i].qryear+"____"+res[i].qrcontent;			   		*/
	var xxx=obj.getAttribute("value");
	var yyyy;
	if(xxx!=null){
		yyyy=xxx.split("____");
	}else{
	...
	window.open("/tqc/qreport.html?qrid="+yyyy[0]+"&time="+new Date().getTime()+"&type="+yyyy[5]);
}