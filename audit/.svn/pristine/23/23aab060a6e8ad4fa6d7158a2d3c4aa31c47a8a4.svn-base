...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>js/ligerui/lib/json2.js"></script>
  	<script type="text/javascript" src="<%=basePath%>js/SpecialtyManage/SpecialtyInstallK.js"></script>
 <script type="text/javascript" src="<%=basePath %>commonjs/common1.js"></script>
 
  </head>
  <body>
   <div class="title_zy"> <p style="margin-left: 12px;color:white;font-family: 'Microsoft YaHei';font-size: 15px">课程设置</p></div>
     <div class="top_zy">
     <div style="margin-left: 30px">
          
           <span>
              <ul  class="top_ul_zy">
                 <li style="padding-top: 5px;padding-right:5px"> <span style="font-size: 14px;">课程名称:</span></li>
           ...
           <span style="float: right;margin-right: 15px">
              <img src="<%=basePath%>images/zypg/addb2.png" style="cursor: pointer;" onclick="addspecialty()"></img>
           </span>
      </div>
     </div>
