...
function downupload() {
	$("#upload_img").show();
	getImg(myChart_1.getDataURL("png"), "report_data_xyh_2_img.png");//获取图片
	getImg(myChart_2.getDataURL("png"), "report_data_xyh_4_img.png");//获取图片
	
	$("#container_1").html("<img src='"+getTomcatRootPath()+"/CHART/images/ASDS_img_glv/report_data_xyh_2_img.png'/>");
	$("#container_2").html("<img src='"+getTomcatRootPath()+"/CHART/images/ASDS_img_glv/report_data_xyh_4_img.png'/>");
