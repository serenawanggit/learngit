		...
		$.ajax({
			...
			success:function(data){
				...
				$.each(datas,function(i,dom){
					if(dom.comment_type==2){
						$("#wpContext").val(dom.comment_suggestions);
					}
				})
			}
		});
			...
			if(obj.children != null && obj.children != undefined && obj.children.length > 0){
				...
				$.each(obj.children,function(j,obj2){
					...
					str += "<tr><td style='width:5%'></td>" +
							"<td width='16%' height='50px'><img src='/audit/page/wangping/staticPage/img/file.png'>&nbsp;&nbsp;<font style='font-size:14px;font-weight:bold'>" + obj2.name + "</font></td>" +
							"<td align='right'><input style='border:#B9B9B9 solid 1px;color:#B9B9B9;font-weight:bold;height:40px;width:100%' readonly='readonly' value='"+wpStr+"'> </td></tr>";
					...
					if(obj2!=undefined){
						...
						if(obj2.children != null && obj2.children != undefined && obj2.children.length > 0){
							$.each(obj2.children,function(k,obj3){
								...
								if(obj3!=undefined){
									str += "<tr><td style='width:5%'></td>" +
									"<td width='16%' height='50px'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='/audit/page/wangping/staticPage/img/file.png'>&nbsp;&nbsp;<font style='font-size:14px;font-weight:bold'>" + obj3.name + "</font></td>" +
									"<td align='right'><input style='border:#B9B9B9 solid 1px;color:#B9B9B9;font-weight:bold;height:40px;width:100%' readonly='readonly' value='"+wpStr+"'> </td></tr>";
//									str += obj3.name + "<br>";
								}
							});
