...
<link rel="stylesheet" type="text/css"
  ...
  <script type="text/javascript" src="<%=basePath%>js/ligerui/lib/jquery.cookie.js"></script>
   <script type="text/javascript" src="<%=basePath%>page/zenith/staticPage/js/specialty.js"></script>
...
<<<<<<< .mine
	...
	<span style="margin-left:1%">专业评估年份:</span><select id = 'dateYear' style="width:70px;height:25px;margin-left:0.8%" onchange="getDate()"></select>
				<div id="divcontent"
...
=======
	...
	<div class = "tableData" style="margin-top:3%;" id="assess_college">
		<span style="margin-left:1%">学院评估年份:</span><select id = 'dateYear' style="width:70px;height:25px;margin-left:0.8%" onchange="getDate()"></select>
			<div id="divcontent" style="background-color:white;height:80%;width:100%; top: 10%;left:8%;overflow-x:auto;">
				<div style="padding: 5px 5px 5px 5px">
					<table style="font-size:12px;width:100%; border:#F8AC59 1px solid;" cellpadding="0" cellspacing="0" id="contenttable">
		...
		<span style="margin-left:1%">课程评估年份:</span><select id = 'dateYear_course' style="width:70px;height:25px;margin-left:0.8%" onchange="getDate()"></select>
			<div id="divcontent" style="background-color:white;height:80%;width:100%; top: 10%;left:8%;overflow-x:auto;">
				<div style="padding: 5px 5px 5px 5px">
		...
		<!-- 专业评估  style="margin-top:3%;" -->
		<div class = "tableData" style="margin-top:3%;" id="assess_major">
		<span style="margin-left:1%">专业评估年份:</span><select id = 'dateYear_major' style="width:70px;height:25px;margin-left:0.8%" onchange="getDate()"></select>
			<div id="divcontent" style="background-color:white;height:80%;width:100%; top: 10%;left:8%;overflow-x:auto;">
				<div style="padding: 5px 5px 5px 5px">
					<table style="font-size:12px;width:100%; border:#F8AC59 1px solid;" cellpadding="0" cellspacing="0" id="course">
						<thead id="tb_thead" class="tb_thead">
							<tr style='background-color:#F8AC59;color:white;font-weight:bold;font-size:12px;'>
								<td nowrap='nowrap' style='padding:0 20px; height:30px;border:#DADADA 1px solid;' align='center'>专业代码</td>
								<td nowrap='nowrap' style='padding:0 20px; height:30px;border:#DADADA 1px solid;' align='center'>专业名称</td>
								<td nowrap='nowrap' style='padding:0 20px; height:30px;border:#DADADA 1px solid;' align='center'>操作</td>
							</tr>
						</thead>
