					...
					<thead>
						<tr>
							<td colspan="22">
								...
								<h4 id="filename">2.2专任教师接受培训进修、交流情况</h4>
								<div class="chocieYear">
									<ul>
										<li>开始年份：
											<select class="select_tips tb_select" id="beginYear" onchange="javascript:Zyselects();">
											...
											结束年份：
											<select class="select_tips tb_select" id="endYear" onchange="javascript:Zyselects();">
											<option>2018/09/30</option>
												<option>2017/09/30</option>
						...
						<tr>
							...
							<td id="td_1" colspan="6">专任教师接受培训进修、交流情况</td>
						</tr>
						<!-- <tr>
							<td>人数</td>
							<td>比例</td>
