  ...
  <body>
    <div id="div1">	
    	...
    	<div id="right">
    			...
    			<div id="right1">
    				<div>
    					<ul id="tab2">
    						...
    						<li><div><span id="nameUser" style="color:white;line-height:25px">fdsafd</span></div></li>
    						...
    						<li><div><a href="javascript:void(0)" onclick="javascript:goblack(-1)" style="cursor:pointer"><img alt="返回列表" src="<%=basePath%>page/zenith/staticPage/img/back.png"></a></div></li>
    		...
    		<div id="main">
  				<iframe id="tempIframe" frameborder="0" scrolling="auto" name="hello" src="<%=basePath%>page/xueyuan/staticPage/Specialty_1.jsp"></iframe>
    		</div>
    	</div>
    </div>
  </body>
