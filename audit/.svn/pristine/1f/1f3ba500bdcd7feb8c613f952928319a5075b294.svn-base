...
public interface AsAssessReportService {
	...
	AssessReport getAllReport(Integer sysid, Integer specialty_id,
			Integer userId, String rYear);

	List<Map<String, Object>> getAllReportBySpeId(String rYear, Integer userId,
			Integer specialtyId, Integer type);
