...
function downupload() {
	$("#upload_img").show();
	getImg(myChart.getDataURL("png"), "report_data_hzsf_1_img.png");//获取图片
	getImg(myChart_1.getDataURL("png"), "report_data_hzsf_2_img.png");//获取图片
	getImg(myChart_2.getDataURL("png"), "report_data_hzsf_4_img.png");//获取图片
	getImg(myChart_3.getDataURL("png"), "report_data_hzsf_3_img.png");//获取图片
	getImg(myChart_4.getDataURL("png"), "report_data_hzsf_5_img.png");//获取图片
	getImg(myChart_5.getDataURL("png"), "report_data_hzsf_7_img.png");//获取图片
	
	$("#table_1_3_bt_zc").html("<img src='"+getTomcatRootPath()+"/CHART/images/ASDS_img_glv/report_data_hzsf_1_img.png'/>");
	$("#container_1").html("<img src='"+getTomcatRootPath()+"/CHART/images/ASDS_img_glv/report_data_hzsf_2_img.png'/>");
	$("#container_2").html("<img src='"+getTomcatRootPath()+"/CHART/images/ASDS_img_glv/report_data_hzsf_4_img.png'/>");
	$("#container_3").html("<img src='"+getTomcatRootPath()+"/CHART/images/ASDS_img_glv/report_data_hzsf_3_img.png'/>");
	$("#container_4").html("<img src='"+getTomcatRootPath()+"/CHART/images/ASDS_img_glv/report_data_hzsf_5_img.png'/>");
	$("#container_5").html("<img src='"+getTomcatRootPath()+"/CHART/images/ASDS_img_glv/report_data_hzsf_7_img.png'/>");
