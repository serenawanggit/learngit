    	...
    	<%-- 	<div id="top">
    			 <div id="left1">
    				<div style="margin-top:-1px">
    					<ul id="tab" >
    						<li><div onclick="jump(0)" style="cursor:pointer">整改报告</div></li>
    						<li><div onclick="javascript:location.reload()" style="cursor:pointer;background-color: rgb(70, 163, 209);">专业质量报告</div></li>
    			...
    			<div id="right1">
    				<div>
    					<ul id="tab2">
    						...
    						<li><div><a href="javascript:void(0)" onclick="javascript:black()" style="cursor:pointer"><img title="返回列表" src="<%=basePath%>page/zenith/staticPage/img/back.png"></a></div></li>
    		...
    		<div id="contentAll2" style="left: 15%;
											width: 75%;
											height:85%;
											display:none;
											background:#fff;
    		...
    		<div id="main" style="margin-right:10px">
					<div style="overflow :auto;
						...
						<div style="background:#46A3D1;height:40px;line-height: 31px;color:#FFFFFF;margin:4px;0px;5px;4px" id="ii">
							<div style="margin-left:10px;" id="name"></div>
						</div>
						<div id="contentAll" style="width:100%;height:85%">
							<!-- 导出按钮 -->
							<div id="outBtn" style="width:100%; height:34px;"><a href="javascript:outfile()" style="float:right;margin-right: 4%;"><img src="img/out.png"></img></a></div>
							<div id="imglodding" style="margin:20 auto;width:383px"><img src="img/loading.png"></img></div>
						</div>
						<!-- 全文预览 -->
						<div id="contentAll3" style="width:100%;height:57%;display:none">
						<!-- 导出按钮 -->
							<div style="width:100%; height:34px;" id="outAll"><a href="javascript:downAll()" style="float:right;margin-right: 4%;"><img src="img/out.png"></img></a></div>
							<div id="imglodding2" style="margin:20 auto;width:383px"><img src="img/loading.png"></img></div>
							<div id="contentBox"></div>
						</div>
					</div>
				    <div id="Zsuggstion" style="margin:13px;">
						<div style="background: #DCDBDB;height: 30px;line-height: 30px;text-align:center">
							网评人总意见
						</div>
						<textarea  id="zYJ" style="width: 100%; height: 80px; resize: none;
						font-size:18px; color:#1d0101;padding: 5px;
						border: 1px solid rgba(113, 113, 113, 0.56);
						font-family: 'Microsoft YaHei';
   						font-size: 16px;" onclick="onDianJi(this)">请输入你的意见</textarea>
						<!--<div>
						<div style="color: red;width: 330px;float: left;">保存按钮保存意见,提交按钮表示审核工作完成!</div>
		    				 <div style="width:100px;float:right"><a href="javascript:tijiao()"><img 
		    				style="float:right;
											margin-top: 9px;
											margin-right: 9px;" 
		    				src="img/submit.png"></img></a></div>
							<div style="width:100%">
								<a href="javascript:void(0)">
								<img style="float:right;
											margin-top: 9px;
											margin-right: 9px;" 
		    					src='/audit/page/xueyuan/staticPage/img/baocun.png' onclick="save1()"/></a>
		    				</div> 
		    			</div>
				   </div>-->
    		</div>
