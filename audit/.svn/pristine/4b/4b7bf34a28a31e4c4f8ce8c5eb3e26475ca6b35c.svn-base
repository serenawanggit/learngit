...
public interface AssessmentSystemService {
	...
	List<Map<String, Object>> getByUserId(Integer id);

	List<Map<String, Object>> getSystemSonByType(Integer id,String syear);//getSystemThreeByType
	...
	List<Map<String, Object>> getRolecategoryByUserId(Integer id);

	List<Map<String, Object>> selectTask(String tYear, Integer specialtyId,
			Integer item);
	
	Map<String, Object> getTaskToShenheOrWangping(String tYear,String specialtyId,String item,String id,String human);

	int updateTaskInfo(Integer selfId, Integer id);

	List<Map<String, Object>> getUserNameById(Integer id);
