...
<!-- 												<option>2011</option> -->
				...
				<tfoot>
					<tr>
						<td colspan="2">
							<font color="red">※以上数据来源：表 1-10 校友会与社会合作。	</font>							
						</td>
					</tr>
				</tfoot>
			</table>
				...
				$.ajax({
					...
					success : function(data){
						...
						if(result==""||result==null){
							$("#table_3_9 tbody").html("<tr><td colspan=\"10\"><font color=\"red\"><b>该年份下没有数据</b></font></td></tr>");
							// hide
							hideLodding();
							return;
						}
					 ...
					 $("#table_3_9 tbody").html("<tr><td colspan=\"2\"><font color=\"red\"><b>该年份下没有数据</b></font></td></tr>");
							// hide
							hideLodding();
					}
					},
