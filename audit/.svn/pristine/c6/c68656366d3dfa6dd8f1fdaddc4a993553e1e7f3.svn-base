...
function initMenuSe(){
	//初始化菜单
	 ...
	 var str1 = "";
	 str1 += "<li ";
	 str1+="> <span  href='javascript:void(0);' onclick=tabimg(this) ><img  src='/audit/images/add1.png' class='img_add_reduce' />学校基本信息</span>";
	 str1 += "<ul  style='overflow:hidden; white-space:nowrap; width:100%; text-overflow: ellipsis;' id='category1' ></ul></li>";
	 
	 var str2 = "";
	 str2 += "<li ";
	 str2 +="> <span  href='javascript:void(0);' onclick=tabimg(this) ><img  src='/audit/images/add1.png' class='img_add_reduce' />学校基本条件</span>";
	 str2 += "<ul  style='overflow:hidden; white-space:nowrap; width:100%; text-overflow: ellipsis;' id='category2'></ul></li>";
	 
	 var str3 = "";
	 str3 += "<li ";
	 str3+="> <span  href='javascript:void(0);' onclick=tabimg(this) ><img  src='/audit/images/add1.png' class='img_add_reduce' />学科专业</span>";
	 str3 += "<ul  style='overflow:hidden; white-space:nowrap; width:100%; text-overflow: ellipsis;' id='category3'></ul></li>";
	 
	 var str4 = "";
	 str4 += "<li ";
	 str4+="> <span  href='javascript:void(0);' onclick=tabimg(this)><img  src='/audit/images/add1.png' class='img_add_reduce' />教师信息</span>";
	 str4 += "<ul  style='overflow:hidden; white-space:nowrap; width:100%; text-overflow: ellipsis;' id='category4'></ul></li>";
	 
	 var str5 = "";
	 str5 += "<li ";
	 str5+="> <span  href='javascript:void(0);' onclick=tabimg(this)><img  src='/audit/images/add1.png' class='img_add_reduce' />人才培养</span>";
	 str5 += "<ul  style='overflow:hidden; white-space:nowrap; width:100%; text-overflow: ellipsis;' id='category5'></ul></li>";
	 
	 var str6 = "";
	 str6 += "<li ";
	 str6+="> <span  href='javascript:void(0);' onclick=tabimg(this) ><img  src='/audit/images/add1.png' class='img_add_reduce' />学生信息</span>";
	 str6 += "<ul  style='overflow:hidden; white-space:nowrap; width:100%; text-overflow: ellipsis;' id='category6'></ul></li>";
	 
	 var str7 = "";
	 str7 += "<li ";
	 str7+="> <span  href='javascript:void(0);' onclick=tabimg(this)><img  src='/audit/images/add1.png' class='img_add_reduce' />教学管理与质量监控</span>";
	 str7 += "<ul  style='overflow:hidden; white-space:nowrap; width:100%; text-overflow: ellipsis;' id='category7'></ul></li>";
	 
	 var str9 = "";
	 str9 += "<li ";
	 str9+="> <span  href='javascript:void(0);' onclick=tabimg(this)><img  src='/audit/images/add1.png' class='img_add_reduce' />课程评估</span>";
	 str9 += "<ul  style='overflow:hidden; white-space:nowrap; width:100%; text-overflow: ellipsis;' id='category9'></ul></li>";
	 str+=str1;str+=str2;str+=str3;str+=str4;str+=str5;str+=str6;str+=str7;str+=str9;
	 $("#left_menu").html(str);
	 ...
	 $.ajax({
		  ...
		  success:function(data){
			 ...
			 for( var i = 0; i < c.length; i++){
					if(c[i].CATEGORY_ID==1){
						category1 +="<li template_id="+c[i].ID+" ctemid="+c[i].CTEMPLATE_ID+" onclick='checkTab1(this,"+c[i].CATEGORY_ID+")'><span>"+c[i].CTEMPLATE_NAME+"</span></li>";
					}
					if(c[i].CATEGORY_ID==2){
						category2 +="<li template_id="+c[i].ID+" ctemid="+c[i].CTEMPLATE_ID+" onclick='checkTab1(this,"+c[i].CATEGORY_ID+")'><span>"+c[i].CTEMPLATE_NAME+"</span></li>";
					}
					if(c[i].CATEGORY_ID==3){
						category3 +="<li template_id="+c[i].ID+" ctemid="+c[i].CTEMPLATE_ID+" onclick='checkTab1(this,"+c[i].CATEGORY_ID+")'><span>"+c[i].CTEMPLATE_NAME+"</span></li>";
					}
					if(c[i].CATEGORY_ID==4){
						category4 +="<li template_id="+c[i].ID+" ctemid="+c[i].CTEMPLATE_ID+" onclick='checkTab1(this,"+c[i].CATEGORY_ID+")'><span>"+c[i].CTEMPLATE_NAME+"</span></li>";
					}
					if(c[i].CATEGORY_ID==5){
						category5 +="<li template_id="+c[i].ID+" ctemid="+c[i].CTEMPLATE_ID+" onclick='checkTab1(this,"+c[i].CATEGORY_ID+")'><span>"+c[i].CTEMPLATE_NAME+"</span></li>";
					}
					if(c[i].CATEGORY_ID==6){
						category6 +="<li template_id="+c[i].ID+" ctemid="+c[i].CTEMPLATE_ID+" onclick='checkTab1(this,"+c[i].CATEGORY_ID+")'><span>"+c[i].CTEMPLATE_NAME+"</span></li>";
					}
					if(c[i].CATEGORY_ID==7){
						category7 +="<li template_id="+c[i].ID+" ctemid="+c[i].CTEMPLATE_ID+" onclick='checkTab1(this,"+c[i].CATEGORY_ID+")'><span>"+c[i].CTEMPLATE_NAME+"</span></li>";
					}
			 ...
			 if(userrole=="校级管理员"){
				 ...
				 for( var i = 0; i < d.length; i++){
					if(d[i].CATEGORY_ID==9){
						category9 +="<li template_id="+d[i].ID+" ctemid="+d[i].CTEMPLATE_ID+" onclick='checkTab1(this,"+d[i].CATEGORY_ID+")'><span>"+d[i].CTEMPLATE_NAME+"</span></li>";
					}
				 }
			 }else{
				 var d=b.content;
				  var t;
				  var s;
				  t=(b.tbr==undefined?"":b.tbr);
				  s=(b.shr==undefined?"":b.shr);
				 for( var i = 0; i < d.length; i++){
						if(d[i].CATEGORY_ID==9){
							category9 +="<li template_id="+d[i].ID+" ctemid="+d[i].CTEMPLATE_ID+" tbr='"+t+"' shr='"+s+"' onclick='checkTab1(this,"+d[i].CATEGORY_ID+")'><span>"+d[i].CTEMPLATE_NAME+"</span></li>";
						}
				 }
			 }
			 ...
			 $("#category7").html(category7);
			 $("#category9").html(category9);
		  },
		  error:function(){
...
function tabimg(element){
	 var a= $(element).parent().parent().find("img");
	 for ( var i = 0; i < a.length; i++) {
		$(a[i]).attr("src","/audit/images/add1.png");
	 }
...
/*	 //教师激励计划用Tid
	...
	var Tid= $("#left_menu").find("li[class=check_li]").attr("ctemid");
	    ...
	    data:{
         ...
         success:function(data){
        	 ...
        	 //excel表头
	            ...
	            var tabletype=result.tableType;
	            if(userstate[0]!=undefined && tabletype==9){
...
function checkTab1(obj,type){
	...
	$("#tab_name").prop("title","当前位置：" + showName);
	 ...
	 var Tinsert_version=$("#importMoeTime").val();
	 if(type!=9){
		 $("#leftsh").attr("style",'background-image:url(\'/audit/images/button_blue.png\');cursor:pointer;display:none;');
		  $("#leftsb").attr("style",'background-image:url(\'/audit/images/button_blue.png\');left:46%;cursor:pointer;display:none;');
		 showData();
	 }else{
			var tbr= $(obj).attr("tbr");
			var shr= $(obj).attr("shr");
	...
	$("#SBpage").show();
     ...
     var tablename= $("#left_menu").find("li[class=check_li]").find("span").text();
      $("#waiting").show();
		$.ajax({
			type:"POST",
			url:"/audit/moeImport/showsbdataForJYB.do",
			data:{"time":time,"id":id},
			dataType:"json",
			success:function(data){
				var a=eval("("+data+")");
