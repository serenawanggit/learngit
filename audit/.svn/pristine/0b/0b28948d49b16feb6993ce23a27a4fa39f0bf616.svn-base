...
<!-- 												<option>2011</option> -->
				...
				<tfoot>
					<tr>
						<td colspan="8">
							<font color="red">※以上数据来源：表3-1 校领导基本信息，表1-6-1 教职工基本信息。<br/>
【注】此表为1.2 校领导年龄和学位结构的详细信息。
		</font>				
						</td>
					</tr>
				</tfoot>
				...
				$.ajax({
					...
					success : function(data){
						...
						if(result==""||result==null){
							hideLodding();
							$("#table_F_3 tbody").html("<tr><td colspan=\"16\"><font color=\"red\"><b>该年份下没有数据</b></font></td></tr>");
							return;
						}
						var html="";
