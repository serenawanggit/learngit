...
<script type="text/javascript"
	src="<%=basePath%>js/SpecialtyManage/installUserForSperialty.js"></script>
...
<body>
	...
	<div style="height:20%;position: relative;">
			<ul id="index">
				<li style="float:left;line-height: 48px;margin-left: 2%;width: 6%;"><span style="font-size: 14px;margin-left: 2%;" id="zhuanyeText">学院名称  :</span></li>
			...
			<div style="display:none;position: absolute;bottom: 24px;right: 290px;" id="Type">
				评估人查找：<select onchange="findUserAdded(this.value)" id="typeUser" class="selector">
					<option value="1">学院自评人</option>
					<option value="2">学院审核人</option>
