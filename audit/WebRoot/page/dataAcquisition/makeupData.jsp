...
<html>
  <head>
    ...
    <script type="text/javascript" src="<%=basePath %>/js/dataAcquisition/makeupData.js"></script>
    ...
    <style type="text/css">
			...
			backgroun d:url(<%=basePath %>/images/centerbk.png);
  ...
  <body>
			...
			<tr>
				  <td style='height:40px;' align='left'>
				    <span style='color:#FFF;display:inline-block;width:175px;font-size:12px;background-image:url(<%=basePath %>/images/subtitleindexbk.png);text-align:center;height:36px;line-height:36px;color:#FFFFFF;'>
				      <span  style='display:inline-block;height:28px;line-height:28px;'>数据补录 >>&nbsp;&nbsp;<span id="academeName"></span> 
				      </span>
				    </span>
				   ...
				   <td style='height:40px;' align='right'>
				      ...
				      <span  style='display:inline-block;height:28px;line-height:28px;cursor:pointer;' onclick="saveData()">保存</span>
				      </span>
				    </span>
				    
				     <span style='color:#FFF;display:inline-block;width:75px;font-size:12px;background-image:url(<%=basePath %>/images/subtitleindexbk.png);text-align:center;height:36px;line-height:36px;color:#FFFFFF;'>
				      <span  style='display:inline-block;height:28px;line-height:28px;cursor:pointer ' onclick="submitData()">提交</span>
				      </span>
				    </span>
				   </td>
			</tr>
	...
	<table style='width:100%;margin-top: 92px;' cellpadding='0' id="pageTb">
						<tbody>
							<tr>
								<td align='left'>
