...
<script type="text/javascript" src="<%=basePath%>page/zenith/staticPage/js/captain.js"></script>
<!--编辑器基本配置-->
...
<input id= "state" type="hidden" value="<%=request.getParameter("state")%>"/>
<input id= "readRole" type="hidden" value="<%=request.getParameter("readRole")%>"/>
	<div id="main" style="Z-index:1">
		...
		<div id = "mids" style="display:none;height:50px;margin-top:20px;">
			...
			<div >
			 <a href="javascript:void(0)" onclick="saveContent(0)" id ="saveContent">
			 <img src="page/zenith/staticPage/img/save.png" style="float:right;"></a>
			<!--  <span style="float:right;" id='showSpan'>（可随时提交保存） </span> -->
			 <div id="changeState" style='display:none'><a href="javascript:void(0)" onclick="changeState();"  ><img src='/audit/page/zenith/staticPage/img/readed.png' style="float:right;"/></a></div>
