...
<!-- 												<option>2011</option> -->
				...
				<tbody>
					...
					<tr>
						<td rowspan="3">本科生创新活动,技能竞赛获奖</td> 
						<td>总数</td>
						<td></td>
					</tr>
				...
				<tfoot>
					<tr>
						<td colspan="3">
							<font color="red">※ 以上数据来源：表 6-2-1 本科生学习成果	</font>							
						</td>
					</tr>
				</tfoot>
			</table>
 ...
 */							// hide
						...
						$("#table_5_6 tbody tr:eq(3) td:eq(2)").html(result[0][3]);
						$("#table_5_6 tbody tr:eq(4) td:eq(1)").html(result[0][4]);
						$("#table_5_6 tbody tr:eq(5) td:eq(1)").html(result[0][5]);
						$("#table_5_6 tbody tr:eq(6) td:eq(2)").html(result[0][6]);
						$("#table_5_6 tbody tr:eq(7) td:eq(1)").html(result[0][7]);
						$("#table_5_6 tbody tr:eq(8) td:eq(1)").html(result[0][8]);
						...
						$("#table_5_6 tbody tr:eq(12) td:eq(2)").html(valueFormat(result[0][12],1));
						$("#table_5_6 tbody tr:eq(13) td:eq(1)").html(valueFormat(result[0][13],1));
						
						$("#table_5_6 tbody tr:eq(14) td:eq(1)").html(valueFormat(result[0][14],1));
						$("#table_5_6 tbody tr:eq(15) td:eq(1)").html(valueFormat(result[0][15],2));
