...
<!-- 												<option>2011</option> -->
				...
				<tbody>
					...
					<tr>
						<td rowspan="5">教育事业收入</td>
						<td colspan="2">教育事业收入总计（万元）</td>
						<td></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2">教学日常支出占经常性预算内教育事业费拨款与本科学费收入之和的比例（%）</td>
						<td></td>
					</tr>
					<tr>
						<td colspan="2">生均本科教学日常运行支出（万元）</td>
						<td></td>
					</tr>
				...
				<tfoot>
					<tr>
						<td colspan="4">
							<font color="red">※ 以上数据来源：表 2-10-1 教学经费概况，表 2-10-2 本科教育经费收支情况， 表 7-3-1 教育教学研究与改革项目。		</font>					
						</td>
					</tr>
				</tfoot>
			</table>
			...
			$("#year").change(function(){
				...
				$.ajax({
					...
					success : function(data){
						...
						if(result=="" || result==null){
							$("#table_1_6 tbody").html("<tr><td colspan=\"4\"><font color=\"red\"><b>该年份下没有数据</b></font></td></tr>");
							// hide
							hideLodding();
							return;
						}
				...
				$.ajax({
					...
					success : function(data){
						...
						$("#table_3_1 tbody tr:eq(7) td:eq(1)").html(valueFormat(result[0][4],2));
						$("#table_3_1 tbody tr:eq(8) td:eq(2)").html(valueFormat(result[0][5],2));
						$("#table_3_1 tbody tr:eq(9) td:eq(1)").html(valueFormat(result[0][6]*100,2));
						$("#table_3_1 tbody tr:eq(10) td:eq(1)").html(valueFormat(result[0][7],2));
