...
<!-- 												<option>2011</option> -->
				...
				<tfoot>
					<tr>
						<td colspan="15">
							<font color="red">※ 以上数据来源：表 1-3 学校相关行政单位， 表 3-3 相关管理人员基本信息， 表 3-2 校领导基本信息（教学副校长） ， 表 1-4 学校教学科研单位。		</font>						
						</td>
					</tr>
				</tfoot>
			</table>
			...
			$("#year").change(function(){
				...
				$.ajax({
					...
					success : function(data){
						...
						$("#table_5_3 tbody tr:eq(1) td:eq(1)").html(valueFormat(result[0][1],1));
				...
				$.ajax({
					...
					success : function(data){
						...
						$("#table_5_3 tbody tr:eq(3) td:eq(1)").html(valueFormat(result[0][1],1));
