...
<!-- 												<option>2011</option> -->
				...
				<tfoot>
					<tr>
						<td colspan="11">
							<font color="red">※ 以上数据来源：表1-5-1专业基本情况，表5-1-1开课情况，表5-1-2专业课教学实施情况表，表1-6-1教职工基本信息，表1-7本科生基本情况，<br/>
							表6-2-1 本科生转专业情况，表6-5-2应届本科毕业生分专业毕业就业情况。<br/>
【注】：1.本表格中授课教师只统计专业课教师，按照《普通高等学校本科专业目录（2012）版》统计。不含外聘人员，含离职人员。<br/>
2.此表为表3.3专业情况概览的详细信息，选择专业的原则是：（专业设置年+4）小于等于当前年
		</font>					
						</td>
					</tr>
				</tfoot>
				...
				$.ajax({
					...
					success : function(data){
						...
						if(result==""||result==null){
							// hide
							hideLodding();
							$("#table_F_12 tbody").html("<tr><td colspan=\"11\"><font color=\"red\"><b>该年份下没有数据</b></font></td></tr>");
							return;
						}
						var html="";
