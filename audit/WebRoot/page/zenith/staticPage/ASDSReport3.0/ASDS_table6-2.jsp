...
<!-- 												<option>2011</option> -->
				...
				<tfoot>
					<tr>
						<td colspan="15">
							<font color="red">※以上数据来源：表1-6-1教职工基本信息，表3-2相关管理人员基本信息，表1-3 学校相关党政单位，表1-4 学校教学科研单位。</font>								
						</td>
					</tr>
				</tfoot>
			</table>
				...
				$.ajax({
					...
					success : function(data){
						...
						if(result==""||result==null){
							$("#table_6_2 tbody").html("<tr><td colspan=\"6\"><font color=\"red\"><b>该年份下没有数据</b></font></td></tr>");
							// hide
							hideLodding();
							return;
						}
