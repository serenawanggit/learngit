...
<!-- 												<option>2011</option> -->
				...
				<tfoot>
					<tr>
						<td colspan="6">
							<font color="red">※以上数据来源：表2-6固定资产。		</font>					
						</td>
					</tr>
				</tfoot> 
			</table>
			...
			$("#year").change(function(){
				...
				$.ajax({
					...
					if(result==""||result==null){
							hideLodding();
							$("#table_3_2_2 tbody tr:eq(0) td:eq(2)").html("");
							$("#table_3_2_2 tbody tr:eq(1) td:eq(1)").html("");
							$("#table_3_2_2 tbody tr:eq(2) td:eq(1)").html("");
							$("#table_3_2_2 tbody tr:eq(3) td:eq(1)").html("");
							$("#abc").html("5000元");
							$("#def").html("10%");
							return;
						}
