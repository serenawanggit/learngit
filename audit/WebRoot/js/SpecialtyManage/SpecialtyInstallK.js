...
function addspecialty() {
	var table="<table  style='margin: 0 auto;border-collapse:   separate;   border-spacing:   10px; '>" +
	  ...
	  "</select></td></tr>"+"<tr style=''><td >课程名称：</td><td><input type='text' id='rolename'/></td></tr>" +
	  "<tr style=''><td >课程代码：</td><td><input type='text' id='remarkcontent'/></td></tr>"+
	  "<tr style='' id='tablewrap'><td>课程类别：<td><select id='test' name='sfgk'>";
...
function updatespecialty(id,name,code,is_sfgk,is_rz){
	var table="<table  style='margin: 0 auto;border-collapse:   separate;   border-spacing:   10px; '><tr style=''><td >课程名称：</td><td><input type='text' id='rolename'/></td></tr>" +
	  "<tr style=''><td >课程代码：</td><td><input type='text' id='remarkcontent'/></td></tr>"+
	  "<tr style='' id='tablewrap'><td>课程类别：<td><select id='test' name='sfgk'>";
