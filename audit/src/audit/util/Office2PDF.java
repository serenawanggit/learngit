 ...
 * @author yuan
 * 
 *  需要OpenOffice第三插件的支持 ,支持window\linux\mac等系统
 */
public class Office2PDF 
{
	...
	private static String getOfficeHome() 
	{
		...
		{
			String OpenOfficePath = System.getProperty("OpenOffice_Path");
			return OpenOfficePath;
//			return "C:/app";
//			return "C:/Program Files/OpenOffice 4";///program
	...
	public static boolean openOffice2Pdf(String inputFilePath, String outputFilePath) 
	{
		...
		if ((null != inputFilePath) && (inputFile.exists())) 
		{
			...
			if (office_Formats.contains(getPostfix(inputFilePath))) 
			{
				...
				{
					// 转换后的文件路径
					System.out.println("这是："+inputFilePath.toLowerCase());
	...
	{
		Office2PDF.openOffice2Pdf("D:\\document\\魔兽争霸中所有单位的英文名大全.doc","D:\\document");
	}
}
