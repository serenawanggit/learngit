...
public class POIReadExcelToHtml {
    ...
    public static void main(String[] args) {
        String path = "E:/assessFileUser/123.xls";//E://Microsoft Excel 工作表.xlsx
        String excel2Hmtl;
		try {
			excel2Hmtl = Excel2Hmtl(path);
			System.out.println(excel2Hmtl);
		} catch (Exception e) {
			e.printStackTrace();
		}
    }
    public static String Excel2Hmtl(String path) throws Exception {
    	int  index=path.indexOf(".");
    	String excelExtName=path.substring(index+1);
    	InputStream is = null;
...
//				htmlExcel = POIReadExcelToHtml.getExcelInfo(wb,true);
     ...
     */
    public static String readExcelToHtml(String filePath , boolean isWithStyle) throws Exception{
