...
public class AS_GJ_SYFX {
	...
	@ExcelAnnotation(exportname = "招收应届毕业生数")
	private String zsyjbyss;
	...
	public String getZzzym() {
		return zzzym;
	}
	public void setZzzym(String zzzym) {
		this.zzzym = zzzym;
	}
	...
	public String getByss() {
		return byss;
	}
	public void setByss(String byss) {
		this.byss = byss;
	}
	...
	public String getZsyjbyss() {
		return zsyjbyss;
	}
	public void setZsyjbyss(String zsyjbyss) {
		this.zsyjbyss = zsyjbyss;
	}
	...
	public String getWnjjyszxs() {
		return wnjjyszxs;
	}
	public void setWnjjyszxs(String wnjjyszxs) {
		this.wnjjyszxs = wnjjyszxs;
	}
	...
	public String toString(){
		...
		sb.append(getXk() + "|" + getZyfl() + "|"  +getZymc() + 
				"|" +  getZzzym()+"|" +  getZydm() + "|" + getNz() +
				"|" +  getByss() + "|"+  getSyxws() + "|" + getZsshj() + 
				"|" +  getZsyjbyss() + "|"  +  getZxshj() + 
				"|" +  getYnjzxs() + "|" +  getEnjzxs()+ 
				"|" +  getSanjzxs() + "|" + getSinjzxs() + 
				"|" + getWnjjyszxs() + "|" + getYjbyss()+ "|" + getId());
		return sb.toString();
	}
}
